package com.tensquare.notice.comtroller;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.tensquare.notice.notice;
...
public class NoticeController {
    ...
    public Result selectByList(@RequestBody Notice notice,
        ...
        IPage<Notice> noticeIPage = noticeService.selectByPage(notice, page, size);
        PageResult<Notice> pageResult = new PageResult<>(
                noticeIPage.getTotal(), noticeIPage.getRecords()
        );
    ...
    public Result freshPage(@PathVariable String userId,
                            @PathVariable Integer page,
                            @PathVariable Integer size) {
        IPage<NoticeFresh> pageData = noticeService.freshPage(userId,page,size);
